...
-- every statement is idempotent. Sections 1–5 set up the synced table; section
-- 6 adds automatic cleanup of stale rooms.
--
...
-- ============================================================================
-- 5. Automatic cleanup of stale rooms (every hour, drop rooms idle >24h) ------
-- ============================================================================
